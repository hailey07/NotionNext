...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '14fd2a0d1cb680c1a751e913f40bd40f,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MoeU33', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名动画师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.moeu33.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, moeu33, 萌酥33, moho', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hokuto.lee@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/1718084', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@MoeU33Hailey', // Youtube主页
  CONTACT_GUMROAD: process.env.NEXT_PUBLIC_CONTACT_GUMROAD || 'https://moeu33.gumroad.com/', // Gumroad主页
  ...
  NOTION_PROPERTY_NAME: {
    ...
    author: process.env.NEXT_PUBLIC_NOTION_PROPERTY_AUTHOR || 'author',
